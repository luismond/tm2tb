...
try:
    ...
    model_es = es_core_news_lg.load(exclude=disabled_comps)
except ModuleNotFoundError:
    print('No Spanish model found')

try:
    import en_core_web_lg
    model_en = en_core_web_lg.load(exclude=disabled_comps)
except ModuleNotFoundError:
    print('No English model found')

try:
    import de_core_news_lg
    model_de = de_core_news_lg.load(exclude=disabled_comps)
except ModuleNotFoundError:
    print('No German model found')

try:
    import fr_core_news_lg
    model_fr = fr_core_news_lg.load(exclude=disabled_comps)
except ModuleNotFoundError:
