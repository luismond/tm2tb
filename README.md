...
**tm2tb** is a term / keyword / n-gram extraction module with a focus on bilingual data. It leverages spaCy's part-of-speech tags and LaBSE's sentence embeddings to extract and align terms from sentences, pairs of sentences and bilingual documents such as translation files.
