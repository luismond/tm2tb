...
It leverages spaCy's part-of-speech tags and LaBSE's sentence embeddings to extract terms from sentences and to match bilingual terms in translated sentences and documents.
